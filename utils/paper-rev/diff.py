...
pos_13_no_AOE = - pos_13_no_AOE[75:440, 1]
rd_14_no_AOE = 3.3 - rd_14_no_AOE[85:490, 0]
pos_14_no_AOE = - pos_14_no_AOE[85:490, 1]
rd_15_no_AOE = 3.3 - rd_15_no_AOE[85:490, 0]
pos_15_no_AOE = - pos_15_no_AOE[85:490, 1]
rd_16_no_AOE = 3.3 - rd_16_no_AOE[155:390, 0]
pos_16_no_AOE = - pos_16_no_AOE[155:390, 1]
rd_17_no_AOE = 3.3 - rd_17_no_AOE[145:350, 0]
pos_17_no_AOE = - pos_17_no_AOE[145:350, 1]
rd_13_under_AOE = 3.3 - rd_13_under_AOE[150:248, 0]
pos_13_under_AOE = - pos_13_under_AOE[150:248, 1]
rd_14_under_AOE = 3.3 - rd_14_under_AOE[359:450, 0]
pos_14_under_AOE = - pos_14_under_AOE[359:450, 1]
rd_15_under_AOE = 3.3 - rd_15_under_AOE[569:661, 0]
pos_15_under_AOE = - pos_15_under_AOE[569:661, 1]
rd_16_under_AOE = 3.3 - rd_16_under_AOE[135:223, 0]
pos_16_under_AOE = - pos_16_under_AOE[135:223, 1]
rd_17_under_AOE = 3.3 - rd_17_under_AOE[363:449, 0]
pos_17_under_AOE = - pos_17_under_AOE[363:449, 1]
...
# derivative
rd_13_no_AOE = np.diff(rd_13_no_AOE, n=1)
rd_14_no_AOE = np.diff(rd_14_no_AOE, n=1)
rd_15_no_AOE = np.diff(rd_15_no_AOE, n=1)
rd_16_no_AOE = np.diff(rd_16_no_AOE, n=1)
rd_17_no_AOE = np.diff(rd_17_no_AOE, n=1)
rd_13_under_AOE = np.diff(rd_13_under_AOE, n=1)
rd_14_under_AOE = np.diff(rd_14_under_AOE, n=1)
rd_15_under_AOE = np.diff(rd_15_under_AOE, n=1)
rd_16_under_AOE = np.diff(rd_16_under_AOE, n=1)
rd_17_under_AOE = np.diff(rd_17_under_AOE, n=1)


fig = plt.figure(figsize=(12,10))
ax = fig.add_subplot(111)

ax.plot(pos_13_under_AOE[1:], rd_13_under_AOE, 'b-', label='-0.2 m, under AOE')
ax.plot(pos_14_under_AOE[1:], rd_14_under_AOE, 'g-', label='-0.1 m, under AOE')
ax.plot(pos_15_under_AOE[1:], rd_15_under_AOE, 'r-', label='0 m, under AOE')
ax.plot(pos_16_under_AOE[1:], rd_16_under_AOE, 'y-', label='0.1 m, under AOE')
ax.plot(pos_17_under_AOE[1:], rd_17_under_AOE, 'k-', label='0.2 m, under AOE')
ax.plot(pos_13_no_AOE[1:], rd_13_no_AOE, 'b--', label='-0.2 m, no AOE')
ax.plot(pos_14_no_AOE[1:], rd_14_no_AOE, 'g--', label='-0.1 m, no AOE')
ax.plot(pos_15_no_AOE[1:], rd_15_no_AOE, 'r--', label='0 m, no AOE')
ax.plot(pos_16_no_AOE[1:], rd_16_no_AOE, 'y--', label='0.1 m, no AOE')
ax.plot(pos_17_no_AOE[1:], rd_17_no_AOE, 'k--', label='0.2 m, no AOE')

ax.set_xlabel("Position (m)")
ax.set_ylabel("Gas sensor reading (V)")
ax.legend()

plt.savefig('experiment_diffed_readings.pdf', format='pdf', bbox_inches="tight")
