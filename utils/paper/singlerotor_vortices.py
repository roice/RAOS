...
# read data
file = h5py.File('singlerotor_vortices_plume.h5', 'r+')
...
file = h5py.File('singlerotor_original_plume.h5', 'r+')
dataset = file['plume']
...
plt.savefig('single_rotor_plumes_uder_AOE.pdf', format='pdf', bbox_inches="tight")
