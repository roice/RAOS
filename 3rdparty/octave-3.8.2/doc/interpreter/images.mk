...
splinefit1.eps: splineimages.m
	$(top_builddir)/run-octave -f -q -H -p $(srcdir) --eval "splineimages ('splinefit1', 'eps');"
splinefit2.eps: splineimages.m
	$(top_builddir)/run-octave -f -q -H -p $(srcdir) --eval "splineimages ('splinefit2', 'eps');"
splinefit3.eps: splineimages.m
	$(top_builddir)/run-octave -f -q -H -p $(srcdir) --eval "splineimages ('splinefit3', 'eps');"
splinefit4.eps: splineimages.m
	$(top_builddir)/run-octave -f -q -H -p $(srcdir) --eval "splineimages ('splinefit4', 'eps');"
splinefit6.eps: splineimages.m
	$(top_builddir)/run-octave -f -q -H -p $(srcdir) --eval "splineimages ('splinefit6', 'eps');"
...
splinefit1.pdf: splineimages.m
	$(top_builddir)/run-octave -f -q -H -p $(srcdir) --eval "splineimages ('splinefit1', 'pdf');"
splinefit2.pdf: splineimages.m
	$(top_builddir)/run-octave -f -q -H -p $(srcdir) --eval "splineimages ('splinefit2', 'pdf');"
splinefit3.pdf: splineimages.m
	$(top_builddir)/run-octave -f -q -H -p $(srcdir) --eval "splineimages ('splinefit3', 'pdf');"
splinefit4.pdf: splineimages.m
	$(top_builddir)/run-octave -f -q -H -p $(srcdir) --eval "splineimages ('splinefit4', 'pdf');"
splinefit6.pdf: splineimages.m
	$(top_builddir)/run-octave -f -q -H -p $(srcdir) --eval "splineimages ('splinefit6', 'pdf');"
...
splinefit1.png: splineimages.m
	$(top_builddir)/run-octave -f -q -H -p $(srcdir) --eval "splineimages ('splinefit1', 'png');"
splinefit2.png: splineimages.m
	$(top_builddir)/run-octave -f -q -H -p $(srcdir) --eval "splineimages ('splinefit2', 'png');"
splinefit3.png: splineimages.m
	$(top_builddir)/run-octave -f -q -H -p $(srcdir) --eval "splineimages ('splinefit3', 'png');"
splinefit4.png: splineimages.m
	$(top_builddir)/run-octave -f -q -H -p $(srcdir) --eval "splineimages ('splinefit4', 'png');"
splinefit6.png: splineimages.m
	$(top_builddir)/run-octave -f -q -H -p $(srcdir) --eval "splineimages ('splinefit6', 'png');"
...
splinefit1.txt: splineimages.m
	$(top_builddir)/run-octave -f -q -H -p $(srcdir) --eval "splineimages ('splinefit1', 'txt');"
splinefit2.txt: splineimages.m
	$(top_builddir)/run-octave -f -q -H -p $(srcdir) --eval "splineimages ('splinefit2', 'txt');"
splinefit3.txt: splineimages.m
	$(top_builddir)/run-octave -f -q -H -p $(srcdir) --eval "splineimages ('splinefit3', 'txt');"
splinefit4.txt: splineimages.m
	$(top_builddir)/run-octave -f -q -H -p $(srcdir) --eval "splineimages ('splinefit4', 'txt');"
splinefit6.txt: splineimages.m
	$(top_builddir)/run-octave -f -q -H -p $(srcdir) --eval "splineimages ('splinefit6', 'txt');"
