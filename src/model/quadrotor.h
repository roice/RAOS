...
class QRdynamic {
    public:
        QRdynamic(float* pos_ref, float* pos, float* vel, float* acc, float* att, float* att_vel, float delta_t, const char*, const char*, QRframe_t*, SimEnvInfo*, float* wind, float* wind_est_incl, float* wind_est_leso); // constructor
        void update(void);
